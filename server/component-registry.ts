...
const REGISTRY_PATH = path.join(process.cwd(), process.env.CONTENT_FOLDER || "content", "component-registry");
...
export function getExampleFilePath(componentType: string, version: string): string {
  return path.join(process.env.CONTENT_FOLDER || "content", "component-registry", componentType, version, "examples");
}
