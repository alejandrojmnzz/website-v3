...
export {
  ...
  type StatItem,
  type LogoItem,
} from "../4geeks-com/component-registry/_common/schema";

// Alias for backward compatibility
export { leadFormDataSchema as productShowcaseFormSchema } from "../4geeks-com/component-registry/_common/schema";
...
export {
  ...
  type HeroOrbit,
} from "../4geeks-com/component-registry/hero/v1.0/schema";
...
} from "../4geeks-com/component-registry/ai_flex_selector/v1.0/schema";
...
export {
  surveyDefaultSchema,
  type SurveyDefault,
} from "../4geeks-com/component-registry/survey/v1.0/schema";
...
} from "../4geeks-com/component-registry/ai_flex_path/v1.0/schema";
...
} from "../4geeks-com/component-registry/ai_learning/v1.0/schema";

// Type alias for backward compatibility
export type AILearningSection = import("../4geeks-com/component-registry/ai_learning/v1.0/schema").AiLearningSection;
...
} from "../4geeks-com/component-registry/mentorship/v1.0/schema";
...
} from "../4geeks-com/component-registry/certificate/v1.0/schema";
...
} from "../4geeks-com/component-registry/text_block/v1.0/schema";
...
} from "../4geeks-com/component-registry/why_learn_ai/v1.0/schema";
...
} from "../4geeks-com/component-registry/pricing/v1.0/schema";
...
export {
  ...
  type FaqSection,
  type FAQ,
} from "../4geeks-com/component-registry/faq/v1.0/schema";

// Type alias for backward compatibility
export type FAQItem = import("../4geeks-com/component-registry/faq/v1.0/schema").FaqItem;
export type FAQSection = import("../4geeks-com/component-registry/faq/v1.0/schema").FaqSection;
...
} from "../4geeks-com/component-registry/testimonials/v1.0/schema";
...
} from "../4geeks-com/component-registry/testimonials_grid/v1.0/schema";
...
} from "../4geeks-com/component-registry/whos_hiring/v1.0/schema";
...
export {
  footerSectionSchema,
  type FooterSection,
} from "../4geeks-com/component-registry/footer/v1.0/schema";
...
} from "../4geeks-com/component-registry/two_column/v1.0/schema";
...
} from "../4geeks-com/component-registry/value_proof_panel/v1.0/schema";
...
} from "../4geeks-com/component-registry/split_cards/v1.0/schema";
...
} from "../4geeks-com/component-registry/numbered_steps/v1.0/schema";
...
} from "../4geeks-com/component-registry/syllabus/v1.0/schema";
...
} from "../4geeks-com/component-registry/projects/v1.0/schema";
...
} from "../4geeks-com/component-registry/features_grid/v1.0/schema";
...
} from "../4geeks-com/component-registry/testimonials_slide/v1.0/schema";
...
export {
  ...
  type CtaBannerForm,
} from "../4geeks-com/component-registry/cta_banner/v1.0/schema";

// Type alias for backward compatibility
export type CTABannerSection = import("../4geeks-com/component-registry/cta_banner/v1.0/schema").CtaBannerSection;
export type CTAButton = import("../4geeks-com/component-registry/_common/schema").CtaButton;
export type LeadFormFieldConfig = z.infer<typeof import("../4geeks-com/component-registry/_common/schema").leadFormFieldConfigSchema>;
...
} from "../4geeks-com/component-registry/project_showcase/v1.0/schema";
...
} from "../4geeks-com/component-registry/comparison_table/v1.0/schema";
...
} from "../4geeks-com/component-registry/geeks_vs_others_comparison/v1.0/schema";
...
} from "../4geeks-com/component-registry/bento_cards/v1.0/schema";
...
export { imageWithStyleSchema } from "../4geeks-com/component-registry/_common/schema";
export type ImageWithStyle = import("../4geeks-com/component-registry/_common/schema").ImageWithStyle;
...
// ============================================
import { twoColumnAccordionCardSectionSchema, twoColumnAccordionCardBulletSchema, type TwoColumnAccordionCardSection, type TwoColumnAccordionCardBullet } from "../4geeks-com/component-registry/two_column_accordion_card/v1.0/schema";
...
// ============================================
import { heroSectionSchema as heroSchema } from "../4geeks-com/component-registry/hero/v1.0/schema";
import { aiLearningSectionSchema } from "../4geeks-com/component-registry/ai_learning/v1.0/schema";
import { mentorshipSectionSchema } from "../4geeks-com/component-registry/mentorship/v1.0/schema";
import { certificateSectionSchema } from "../4geeks-com/component-registry/certificate/v1.0/schema";
import { whyLearnAISectionSchema } from "../4geeks-com/component-registry/why_learn_ai/v1.0/schema";
import { pricingSectionSchema } from "../4geeks-com/component-registry/pricing/v1.0/schema";
import { faqSectionSchema } from "../4geeks-com/component-registry/faq/v1.0/schema";
import { testimonialsSectionSchema } from "../4geeks-com/component-registry/testimonials/v1.0/schema";
import { whosHiringSectionSchema } from "../4geeks-com/component-registry/whos_hiring/v1.0/schema";
import { footerSectionSchema } from "../4geeks-com/component-registry/footer/v1.0/schema";
import { twoColumnSectionSchema } from "../4geeks-com/component-registry/two_column/v1.0/schema";
import { numberedStepsSectionSchema } from "../4geeks-com/component-registry/numbered_steps/v1.0/schema";
import { syllabusSectionSchema } from "../4geeks-com/component-registry/syllabus/v1.0/schema";
import { projectsSectionSchema } from "../4geeks-com/component-registry/projects/v1.0/schema";
import { featuresGridSectionSchema as featuresGridSchema } from "../4geeks-com/component-registry/features_grid/v1.0/schema";
import { testimonialsSlideSectionSchema } from "../4geeks-com/component-registry/testimonials_slide/v1.0/schema";
import { testimonialsGridSectionSchema } from "../4geeks-com/component-registry/testimonials_grid/v1.0/schema";
import { ctaBannerSectionSchema } from "../4geeks-com/component-registry/cta_banner/v1.0/schema";
import { projectShowcaseSectionSchema, projectsShowcaseSectionSchema } from "../4geeks-com/component-registry/project_showcase/v1.0/schema";
import { comparisonTableSectionSchema } from "../4geeks-com/component-registry/comparison_table/v1.0/schema";
import { geeksVsOthersComparisonSectionSchema } from "../4geeks-com/component-registry/geeks_vs_others_comparison/v1.0/schema";
import { bulletTabsShowcaseSectionSchema, type BulletTabsShowcaseSection, type BulletTab } from "../4geeks-com/component-registry/bullet_tabs_showcase/v1.0/schema";
export { bulletTabsShowcaseSectionSchema, type BulletTabsShowcaseSection, type BulletTab };
import { graduatesStatsSectionSchema, graduatesFeaturedImageSchema, type GraduatesStatsSection, type GraduatesStatItem, type GraduatesCollageImage, type GraduatesFeaturedImage, type GraduatesStatsAsymmetric } from "../4geeks-com/component-registry/graduates_stats/v1.0/schema";
import { splitCardsSectionSchema } from "../4geeks-com/component-registry/split_cards/v1.0/schema";
...
import { applyFormSectionSchema } from "../4geeks-com/component-registry/apply_form/v1.0/schema";
import { awardBadgesSectionSchema } from "../4geeks-com/component-registry/award_badges/v1.0/schema";
import { awardsMarqueeSectionSchema, type AwardsMarqueeSection, type AwardsMarqueeItem } from "../4geeks-com/component-registry/awards_marquee/v1.0/schema";
export { awardsMarqueeSectionSchema, type AwardsMarqueeSection, type AwardsMarqueeItem };
import { listPressMentionsSectionSchema, type ListPressMentionsSection, type PressMentionItem, pressMentionsSectionSchema, type PressMentionsSection } from "../4geeks-com/component-registry/list_press_mentions/v1.0/schema";
...
export { listSinglePressMentionSectionSchema, type ListSinglePressMentionSection } from "../4geeks-com/component-registry/list_single_press_mention/v1.0/schema";
import { valueProofPanelSectionSchema } from "../4geeks-com/component-registry/value_proof_panel/v1.0/schema";
import { stickyCtaSectionSchema } from "../4geeks-com/component-registry/sticky_cta/v1.0/schema";
export { stickyCtaSectionSchema, type StickyCtaSection } from "../4geeks-com/component-registry/sticky_cta/v1.0/schema";
import { modalSectionSchema } from "../4geeks-com/component-registry/modal/v1.0/schema";
export { modalSectionSchema, type ModalSection } from "../4geeks-com/component-registry/modal/v1.0/schema";
import { bentoCardsSectionSchema } from "../4geeks-com/component-registry/bento_cards/v1.0/schema";
import { bannerSchema, bannerSectionSchema, bannerMarqueeBadgesSchema, type BannerSection, type BannerMarqueeBadges } from "../4geeks-com/component-registry/banner/v1.0/schema";
export { bannerSectionSchema, bannerMarqueeBadgesSchema, type BannerSection, type BannerMarqueeBadges };
import { imageRowSectionSchema, type ImageRowSection } from "../4geeks-com/component-registry/image_row/v1.0/schema";
export { imageRowSectionSchema, type ImageRowSection };
import { courseSelectorSectionSchema, type CourseSelectorSection, type CourseItem, type CourseBadge, type CourseTag } from "../4geeks-com/component-registry/course_selector/v1.0/schema";
export { courseSelectorSectionSchema, type CourseSelectorSection, type CourseItem, type CourseBadge, type CourseTag };
import { articleSectionSchema, type ArticleSection } from "../4geeks-com/component-registry/article/v1.0/schema";
export { articleSectionSchema, type ArticleSection };
import { partnershipCarouselSectionSchema, type PartnershipCarouselSection, type PartnershipSlide } from "../4geeks-com/component-registry/partnership_carousel/v1.0/schema";
export { partnershipCarouselSectionSchema, type PartnershipCarouselSection, type PartnershipSlide };
import { careerSupportExplainSectionSchema, type CareerSupportExplainSection, type CareerSupportTab, type CareerSupportBox, type CareerSupportBullet, type CareerSupportStat, type CareerSupportLogo, type CareerSupportTestimonial, type CareerSupportTestimonialLogo } from "../4geeks-com/component-registry/career_support_explain/v1.0/schema";
...
import { profilesCarouselSectionSchema, type ProfilesCarouselSection, type ProfileCard } from "../4geeks-com/component-registry/profiles_carousel/v1.0/schema";
export { profilesCarouselSectionSchema, type ProfilesCarouselSection, type ProfileCard };

import { dynamicTableSectionSchema, type DynamicTableSection, type DynamicTableColumn, type DynamicTableAction } from "../4geeks-com/component-registry/dynamic_table/v1.0/schema";
export { dynamicTableSectionSchema, type DynamicTableSection, type DynamicTableColumn, type DynamicTableAction };

import { doubleCTASectionSchema, type DoubleCTASection, type DoubleCTABox, type DoubleCTABullet } from "../4geeks-com/component-registry/double_cta/v1.0/schema";
export { doubleCTASectionSchema, type DoubleCTASection, type DoubleCTABox, type DoubleCTABullet };

import { contactUsInfoSectionSchema, type ContactUsInfoSection, type ContactLocation } from "../4geeks-com/component-registry/contact_us_info/v1.0/schema";
export { contactUsInfoSectionSchema, type ContactUsInfoSection, type ContactLocation };

import { trustCardsSectionSchema, type TrustCardsSection, type TrustCardItem } from "../4geeks-com/component-registry/trust_cards/v1.0/schema";
export { trustCardsSectionSchema, type TrustCardsSection, type TrustCardItem };

import { programsShowcaseSectionSchema, type ProgramsShowcaseSection, type ProgramItem } from "../4geeks-com/component-registry/programs_showcase/v1.0/schema";
export { programsShowcaseSectionSchema, type ProgramsShowcaseSection, type ProgramItem };

import { credibilityStripSectionSchema, type CredibilityStripSection, type CredibilityStripItem, type CredibilityStripLogo } from "../4geeks-com/component-registry/credibility_strip/v1.0/schema";
